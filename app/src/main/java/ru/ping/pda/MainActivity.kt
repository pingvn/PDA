...
class MainActivity : AppCompatActivity() , MapFragment.OnFragmentInteractionListener,View.OnClickListener{
    ...
    fun runFragment(run_parametr:String){
        when(run_parametr){
            FRAGMENT_MAP_NEW->{  supportFragmentManager.beginTransaction().add(R.id.id_Conteiner_Fragment,MapFragment()).commit()}
            FRAGMENT_MAP_REFRESH->{  supportFragmentManager.beginTransaction().replace(R.id.id_Conteiner_Fragment,MapFragment()).commit()}
        }
